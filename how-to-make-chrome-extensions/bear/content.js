...
$( ".confirmButton" ).click(function() {
    ...
    if(value == 3){
        $(this).closest(".wrapperDiv").next().attr("style", "background-color:"+GREEN_COLOR+"!important");
    }
    if(value == 2){
        $(this).closest(".wrapperDiv").next().attr("style", "background-color:"+BLUE_COLOR+"!important");
    }
    if(value == 1){
        $(this).closest(".wrapperDiv").next().attr("style", "background-color:"+RED_COLOR+"!important");
    }
    if(value == 0){
        $(this).closest(".wrapperDiv").next().attr("style", "background-color:"+TRANSPARENT_COLOR);
    }
